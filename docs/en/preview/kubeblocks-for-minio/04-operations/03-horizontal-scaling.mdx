...
:::caution
MinIO does not support scale-in. Once nodes are added to a distributed pool, they cannot be removed. Attempting to scale in will permanently delete the PVCs of the removed nodes and cause data loss.
:::
