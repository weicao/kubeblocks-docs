  ...
  return (
    <>
      <style>{`
        ...
        .minio-ha-diagram .dot-orange { background: #e3b341; }
        .minio-ha-diagram .dot-teal   { background: #56d4dd; }
        ...
        .minio-ha-diagram .sidebar-card { border-radius: 10px; border: 1px solid; padding: 12px 14px; }
        .minio-ha-diagram .dcs-card { border-color: #1b7c83; background: #0a1e20; }
        .minio-ha-diagram .dcs-items { display: flex; flex-direction: column; gap: 5px; margin-top: 8px; }
        .minio-ha-diagram .dcs-item {
          padding: 5px 9px; border-radius: 6px; border: 1px solid #1b7c8355;
          background: #061515; font-size: 10px; color: #56d4dd; line-height: 1.5;
        }
        .minio-ha-diagram .dcs-item span { color: #7d8590; }
        .minio-ha-diagram .failover-card { border-color: #da3633; background: #1c0a0a; }
        .minio-ha-diagram .failover-steps { display: flex; flex-direction: column; gap: 4px; margin-top: 8px; }
        .minio-ha-diagram .step { display: flex; align-items: flex-start; gap: 7px; font-size: 10px; color: #cdd9e5; line-height: 1.5; }
        .minio-ha-diagram .step-num {
        ...
        .minio-ha-diagram .accounts-card { border-color: #d2992244; background: #1a1505; }
        .minio-ha-diagram .accounts-grid { display: flex; flex-wrap: wrap; gap: 5px; margin-top: 8px; }
        .minio-ha-diagram .acc-chip {
          padding: 3px 8px; border-radius: 5px;
          border: 1px solid #d2992233; background: #0d0d00; font-size: 10px; color: #e3b341;
        }
        .minio-ha-diagram .acc-chip span { color: #484f58; font-size: 9px; display: block; }
        .minio-ha-diagram .operator-block {
          flex: 1; border-radius: 12px; border: 1px solid #1f6feb;
          background: #0d1f38; padding: 16px 20px;
        }
        .minio-ha-diagram .operator-controllers { display: flex; gap: 8px; margin-top: 8px; }
        .minio-ha-diagram .ctrl-chip {
        ...
        .minio-ha-diagram .ctrl-chip .ctrl-name { font-weight: 700; font-size: 12px; display: block; margin-bottom: 2px; }
        .minio-ha-diagram .ctrl-chip .ctrl-sub { font-size: 10px; color: #4a7ab5; }
        .minio-ha-diagram .crd-chain { display: flex; align-items: center; gap: 6px; margin-top: 10px; flex-wrap: wrap; }
        .minio-ha-diagram .crd-chip { padding: 4px 10px; border-radius: 20px; border: 1px solid; font-size: 11px; font-weight: 600; white-space: nowrap; }
        .minio-ha-diagram .crd-chip.cluster     { border-color: #a371f7; color: #d2a8ff; background: #2d1f5e; }
        .minio-ha-diagram .crd-chip.component   { border-color: #79c0ff; color: #79c0ff; background: #1a3050; }
        .minio-ha-diagram .crd-chip.instanceset { border-color: #7ee787; color: #7ee787; background: #1a3020; }
        .minio-ha-diagram .crd-chip.pod         { border-color: #e3b341; color: #e3b341; background: #302010; }
        .minio-ha-diagram .crd-arrow { color: #484f58; font-size: 14px; }
      ...
      <div className="minio-ha-diagram">
          ...
          <div className="mgmt-sidebar">
            ...
            <div className="sidebar-card dcs-card">
              <div className="card-title" style={{color:'#56d4dd',fontSize:'10px'}}>
                ...
                <span style={{fontSize:'9px',color:'#1b7c83',fontWeight:400}}>(Distributed Mode Config)</span>
              </div>
              <div className="dcs-items">
                <div className="dcs-item">
                  <span>Erasure set</span> / EC:4+4 (configurable)<br/>
                  no single point of failure
                </div>
                <div className="dcs-item">
                  <span>Bitrot protection</span> / per-object checksums<br/>
                  healing on access
                </div>
                <div className="dcs-item">
            ...
            <div className="sidebar-card failover-card">
              ...
              <div className="failover-steps">
                <div className="step"><span className="step-num">1</span>Node/drive failure detected</div>
                <div className="step"><span className="step-num">2</span>Quorum check: ≥ N/2+1 drives available</div>
                <div className="step"><span className="step-num">3</span>Read healing via parity reconstruction</div>
                <div className="step"><span className="step-num">4</span>Background heal task re-encodes missing shards</div>
                <div className="step"><span className="step-num">5</span>Node rejoins and re-syncs data</div>
                <div className="step"><span className="step-num">6</span>Cluster returns to full redundancy</div>
              </div>
            </div>
            ...
            <div className="sidebar-card accounts-card">
              ...
              <div className="accounts-grid">
                <div className="acc-chip">root<span>superuser (initAccount)</span></div>
              </div>
            </div>
        ...
        <div style={{display:'flex',gap:'16px',alignItems:'stretch',marginTop:'4px'}}>
          <div className="operator-block">
            ...
            <div className="operator-controllers">
              ...
              <div className="ctrl-chip">
                ...
                <span className="ctrl-sub">Scale / Expand</span>
              </div>
            </div>
            <div style={{marginTop:'10px'}}>
              ...
              <div className="crd-chain">
                ...
                <span className="crd-arrow">→</span>
                <div className="crd-chip pod">Pod × 4</div>
              </div>
            </div>
          </div>
          ...
          <div style={{width:'220px',flexShrink:0,borderRadius:'12px',border:'1px solid #1f6feb33',background:'#0a1628',padding:'14px 16px',display:'flex',flexDirection:'column',justifyContent:'center',gap:'6px'}}>
            ...
            <div style={{fontSize:'10px',color:'#4a7ab5',lineHeight:1.9}}>
              ...
              ⚙ roleProbe: exec <code style={{color:'#3fb950'}}>mc admin info</code> → readwrite / notready<br/>
              ⚙ Volume expansion (online)<br/>
              ⚙ Execute horizontal scale ops<br/>
        ...
        <div className="legend">
          ...
          <div className="legend-item"><span className="legend-dot" style={{background:'#f85149'}}></span>Auto-Healing</div>
