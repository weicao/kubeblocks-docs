...
function ComparisonTable() {
  ...
  const cols = [
    ...
    { label: 'Altinity Operator', highlight: false },
    { label: 'Bitnami Helm',      highlight: false },
  ];
      ...
      <Container maxWidth="lg">
        ...
        <Box sx={{ overflowX: 'auto', borderRadius: '14px', border: `1px solid ${cardBorder}` }}>
          <Box component="table" sx={{ width: '100%', borderCollapse: 'collapse', bgcolor: cardBg }}>
            ...
            <Box component="tbody">
              {rows.map(({ feature, kb, altinity, bitnami }) => (
                <Box
                  key={feature}
                  component="tr"
                  sx={{
                  ...
                  {[kb, altinity, bitnami].map((val, j) => (
                    <Box
                      ...
                      sx={{
                        ...
                        borderLeft: `1px solid ${cardBorder}`,
                        bgcolor: j === 0
                          ? (isDark ? alpha(theme.palette.primary.main, 0.06) : alpha(theme.palette.primary.main, 0.03))
                          : 'inherit',
                      }}
                    >
                      {val}
        ...
        <Typography variant="body2" sx={{ color: 'text.secondary', textAlign: 'center', mt: 0.75, fontSize: '0.75rem' }}>
          ...
          = Available in KubeBlocks Enterprise edition. Based on documentation and GitHub issues; features may vary by version.
        </Typography>
      </Container>
    </Box>
  );
