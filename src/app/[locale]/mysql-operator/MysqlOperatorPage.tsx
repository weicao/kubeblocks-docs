...
const BENCH_CARDS = [
  ...
  },
  {
    ...
    desc: 'With proper parameter tuning and IOPS, running MySQL on Kubernetes introduces no performance degradation vs. bare-VM deployments.',
  },
];
...
function ComparisonTable() {
  ...
  const rows = [
    ...
    { feature: 'Standby cluster (cross-k8s DR)',
      kb: ENT,  oracle: NO,   percona: NO,   bitpoke: NO   },
