...
function Comparison() {
  ...
  const cols = [
    ...
    { label: 'Pravega ZK Operator',    highlight: false },
  ];
      ...
      <Container maxWidth="lg">
        <Box textAlign="center" mb={6}>
          ...
          <Typography variant="h4" fontWeight={700} sx={{ letterSpacing: '-0.03em', lineHeight: 1.15 }}>
            ...
            <Box component="span" color="primary.main">Other ZooKeeper Options</Box>
          </Typography>
        </Box>
        ...
        <Box sx={{ overflowX: 'auto', borderRadius: '14px', border: `1px solid ${cardBorder}` }}>
          <Box component="table" sx={{ width: '100%', borderCollapse: 'collapse', bgcolor: cardBg }}>
            ...
            <Box component="tbody">
              {rows.map(({ feature, kb, bitnami, pravega }) => (
                <Box
                  key={feature}
                  component="tr"
                  sx={{
