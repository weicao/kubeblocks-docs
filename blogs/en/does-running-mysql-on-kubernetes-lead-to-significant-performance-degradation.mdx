...
Does running [MySQL](/mysql-operator) on Kubernetes lead to significant performance degradation? Although concerns about this have been raised recently, few tests have been conducted, and results have rarely been shared publicly.
...
- [KubeBlocks for MySQL](/mysql-operator)
- [KubeBlocks for PostgreSQL](/pg-operator)
