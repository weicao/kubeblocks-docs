...
title: 'MySQL on Kubernetes Performance: A Benchmark of KubeBlocks, Percona, and Oracle Operators vs. Amazon RDS'
description: Does running MySQL on Kubernetes degrade performance? This report answers the question with a detailed benchmark comparing KubeBlocks, Percona, and Oracle operators against Amazon RDS. We analyze throughput and latency, revealing how factors like parameter tuning and IOPS are the real performance drivers.
date: 2023-08-18
authors:
  name: Thomas
  url: https://github.com/realzyy
  image_url: https://avatars.githubusercontent.com/u/1814084?v=4
tags: [Benchmark, MySQL, Addons, Performance]
Keywords: MySQL, Kubernetes, Performance, Benchmark, Amazon RDS, KubeBlocks, Percona, MySQL Operator, Throughput, Latency, IOPS, Sysbench, Stateful Application, OLTP, AWS
image: /img/blogs/thumbnails/blog-mysql.png
---

# Does running MySQL on Kubernetes lead to significant performance degradation?

Does running [MySQL](/docs/preview/kubeblocks-for-mysql) on Kubernetes lead to significant performance degradation? Although concerns about this have been raised recently, few tests have been conducted, and results have rarely been shared publicly.
...
<div>
  <img src='/img/blogs/MySQL-and-sysbench-are-deployed-in-the-same-K8s-cluster.png' alt="Deploy MySQL and sysbench in the same K8s cluster" style={{padding: "10px 10%"}} />
</div>

#### Read-intensive workload

<div style={{display: "flex"}}>
  <img src='/img/blogs/Read-intensive-workload-1.png' alt="Image 1" width='33%' style={{padding: "5px"}} />
  <img src='/img/blogs/Read-intensive-workload-3.png' alt="Image 3" width="33%" style={{padding: "5px"}} />
  <img src='/img/blogs/Read-intensive-workload-6.png' alt="Image 6" width="33%" style={{padding: "5px"}} />
</div>
<div style={{display: "flex"}}>
  <img src='/img/blogs/Read-intensive-workload-2.png' alt="Image 2" width="33%" style={{padding: "5px"}} />
  <img src='/img/blogs/Read-intensive-workload-5.png' alt="Image 5" width="33%" style={{padding: "5px"}} />
  <img src='/img/blogs/Read-intensive-workload-7.png' alt="Image 7" width="33%" style={{padding: "5px"}} />
</div>

#### Read-write balanced workload

<div style={{display: "flex"}}>
  <img src='/img/blogs/Read-write-balanced-workload-1.png' alt="Image 1" width="33%" style={{padding: "5px"}} />
  <img src='/img/blogs/Read-write-balanced-workload-3.png' alt="Image 3" width="33%" style={{padding: "5px"}} />
  <img src='/img/blogs/Read-write-balanced-workload-5.png' alt="Image 5" width="33%" style={{padding: "5px"}} />
</div>
<div style={{display: "flex"}}>
  <img src='/img/blogs/Read-write-balanced-workload-2.png' alt="Image 2" width="33%" style={{padding: "5px"}} />
  <img src='/img/blogs/Read-write-balanced-workload-4.png' alt="Image 4" width="33%" style={{padding: "5px"}} />
  <img src='/img/blogs/Read-write-balanced-workload-6.png' alt="Image 6" width="33%" style={{padding: "5px"}} />
</div>

#### Write-intensive workload

<div style={{display: "flex"}}>
  <img src='/img/blogs/Write-intensive-workload-1.png' alt="Image 1" width="33%" style={{padding: "5px"}} />
  <img src='/img/blogs/Write-intensive-workload-3.png' alt="Image 3" width="33%" style={{padding: "5px"}} />
  <img src='/img/blogs/Write-intensive-workload-5.png' alt="Image 5" width="33%" style={{padding: "5px"}} />
</div>
<div style={{display: "flex"}}>
  <img src='/img/blogs/Write-intensive-workload-2.png' alt="Image 2" width="33%" style={{padding: "5px"}} />
  <img src='/img/blogs/Write-intensive-workload-4.png' alt="Image 4" width="33%" style={{padding: "5px"}} />
  <img src='/img/blogs/Write-intensive-workload-6.png' alt="Image 6" width="33%" style={{padding: "5px"}} />
</div>

### MySQL and sysbench are deployed in two K8s clusters

<div>
  <img src='/img/blogs/MySQL-and-sysbench-are-deployed-in-two-K8s-clusters.png' alt="MySQL and sysbench are deployed in two K8s clusters" style={{padding: "10px 10%"}} />
</div>

#### Read-intensive workload

<div style={{display: "flex"}}>
  <img src='/img/blogs/Read-intensive-workload-two-1.png' alt="Image 1" width="33%" style={{padding: "5px"}} />
  <img src='/img/blogs/Read-intensive-workload-two-3.png' alt="Image 3" width="33%" style={{padding: "5px"}} />
  <img src='/img/blogs/Read-intensive-workload-two-5.png' alt="Image 5" width="33%" style={{padding: "5px"}} />
</div>
<div style={{display: "flex"}}>
  <img src='/img/blogs/Read-intensive-workload-two-2.png' alt="Image 2" width="33%" style={{padding: "5px"}} />
  <img src='/img/blogs/Read-intensive-workload-two-4.png' alt="Image 4" width="33%" style={{padding: "5px"}} />
  <img src='/img/blogs/Read-intensive-workload-two-6.png' alt="Image 6" width="33%" style={{padding: "5px"}} />
</div>
