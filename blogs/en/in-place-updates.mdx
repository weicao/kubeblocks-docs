...
title: Achieving In-Place Pod Updates on Kubernetes for High Availability Databases with KubeBlocks
description: Learn how KubeBlocks enables in-place Pod updates on Kubernetes to improve high availability for databases. This article explains how KubeBlocks' InstanceSet overcomes the limitations of StatefulSet, allowing updates to images, CPU/memory resources, and PVC volumes without disruptive Pod recreation.
date: 2024-11-19
authors:
  name: free6om
...
Keywords: In-Place Update, Kubernetes, KubeBlocks, InstanceSet, StatefulSet, High Availability, Pod Update, Vertical Scaling, InPlacePodVerticalScaling, PVC Expansion, Database on Kubernetes, Pod Recreation, Resource Update, Image Update, Operator
