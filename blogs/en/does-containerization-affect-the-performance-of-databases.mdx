...
description: An in-depth analysis of containerization's impact on database performance. This article benchmarks CPU, memory, and I/O for container runtimes like runC, Kata Containers, and gVisor, and investigates common bottlenecks like I/O hangs and OOM errors in a Kubernetes environment.
date: 2024-01-26
authors:
  name: dullboy
...
Keywords: Database Performance, Containerization, Kubernetes, Benchmark, runC, Kata Containers, gVisor, CPU Performance, Disk I/O, Network Performance, CNI, eBPF, Performance Bottlenecks, Out of Memory (OOM), Stateful Workloads
...
<span style={{ display: "flex", justifyContent: "center", margin: "-6px 0 10px", fontSize: "12px" }}>Fig. 1. Usage of containerized workloads by category<sup>[4]</sup></span>
...
<img src='/img/blogs/Comparison-of-system-architecture.png'  alt="Comparison of system architecture of various lightweight virtualization methods"  />

<span style={{ display: "flex", justifyContent: "center", margin: "-6px 0 10px", fontSize: "12px" }}>Fig. 2. Comparison of system architecture of various lightweight virtualization methods. Orange for kernel space, green for user space.<sup>[2]</sup></span>
...
<img src='/img/blogs/Architecture-of-runc.png'  alt="Architecture of  RunC"   />

<span style={{ display: "flex", justifyContent: "center", margin: "-6px 0 10px", fontSize: "12px" }}>Fig. 3. Architecture of RunC</span>
...
<img src='/img/blogs/Architecture-of-Kata-Containers.png'  alt="Architecture of Kata Containers"   />
...
3. Databases are powerhouses that need to perform at top speed.
   ...
   Databases come with a variety of performance needs that can be sorted into categories like CPU, memory, network, and storage. For instance, when it comes to handling massive data analysis, products like [ClickHouse](/docs/preview/kubeblocks-for-clickhouse) and Greenplum are heavy on CPU and storage I/O. On the flip side, databases such as [Redis](/docs/preview/kubeblocks-for-redis) and Memcached are more demanding on memory and network I/O. Then there are the classic workhorses like [MySQL](/docs/preview/kubeblocks-for-mysql) and [PostgreSQL](/docs/preview/kubeblocks-for-postgresql), which are traditional OLTP databases that also lean heavily on CPU and storage I/O. What's more, even within a single database, the thirst for resources can shift dramatically based on the type of query being run.
...
<img src='/img/blogs/CPU-performance-Sysbench-benchmark.png'  alt="CPU performance (Sysbench benchmark)"   />

<span style={{ display: "flex", justifyContent: "center", margin: "-6px 0 10px", fontSize: "12px" }}>Fig. 7. CPU performance (Sysbench benchmark) (Xingyu Wang 2022)</span>
...
<img src='/img/blogs/CPU-performance-Dav1d-benchmark.png'  alt="CPU performance (Dav1d benchmark)"   />

<span style={{ display: "flex", justifyContent: "center", margin: "-6px 0 10px", fontSize: "12px" }}>Fig. 8. CPU performance (Dav1d benchmark) (Xingyu Wang 2022)</span>
...
<img src='/img/blogs/Memory-access-performance.png'  alt="Memory access performance"   />
...
<img src='/img/blogs/Redis-performance-for-different-container-runtimes.png'  alt="Redis performance for different container runtimes"   />

<span style={{ display: "flex", justifyContent: "center", margin: "-6px 0 10px", fontSize: "12px" }}>Fig. 10. Redis performance for different container runtimes (Xingyu Wang 2022)</span>
...
<span style={{ display: "flex", justifyContent: "center", margin: "-6px 0 10px", fontSize: "12px" }}>Fig. 11. Disk read and write performance (Xingyu Wang 2022)</span>
...
<span style={{ display: "flex", justifyContent: "center", margin: "-6px 0 10px", fontSize: "12px" }}>Fig. 12. Disk read and write performance (tmpfs overlay) (Xingyu Wang 2022)</span>
...
<span style={{ display: "flex", justifyContent: "center", margin: "-6px 0 10px", fontSize: "12px" }}>Fig. 13. Database record insertion performance (Xingyu Wang 2022)</span>
...
<span style={{ display: "flex", justifyContent: "center", margin: "-6px 0 10px", fontSize: "12px" }}>Fig. 14. TCP_STREAM network performance (Xingyu Wang 2022)</span>
...
<span style={{ display: "flex", justifyContent: "center", margin: "-6px 0 10px", fontSize: "12px" }}>Fig. 15. TCP_RR, TCP_CRR and UDP_RR performance (Xingyu Wang 2022)</span>
...
<img src='/img/blogs/Comparison-of-legacy-and-eBPF-container-networking.png'  alt="Comparison of legacy and eBPF container networking"   />
...
<img src='/img/blogs/Redis-benchmark-under-legacy-host-routing-with-iptables.png'  alt="Redis benchmark under legacy host-routing with iptables"   />

<span style={{ display: "flex", justifyContent: "center", margin: "-6px 0 10px", fontSize: "12px" }}>Fig. 17. Redis benchmark under legacy host-routing with iptables</span>
