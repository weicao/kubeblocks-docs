...
- Advanced: [KubeBlocks supports [Redis](/docs/preview/kubeblocks-for-redis) PITR (Point-in-Time Recovery) and recovery of specific keys](https://summer-ospp.ac.cn/org/prodetail/248330238?lang=en&list=pro)
