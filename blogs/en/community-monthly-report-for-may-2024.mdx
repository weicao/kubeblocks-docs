...
- [#7475](https://github.com/apecloud/kubeblocks/pull/7475) Fixed the crash issue after executing a switchover for [MongoDB](/docs/preview/kubeblocks-for-mongodb).
