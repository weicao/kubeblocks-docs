...
tags: [Use Case]
keywords: kubeblocks,operator,operatorization,amazon-eks,EKS,qdrant,vector-database,aigc,vector-db,instanceset,stateful,ai-infrastructure,kubernetes-operator,milvus-operator
...
![KubeBlocks architecture](/img/blogs/use-kubeblocks-to-build1.png)
...
[Qdrant](/docs/preview/kubeblocks-for-qdrant) is an open-source vector database designed to efficiently store and query high-dimensional vector data. The architecture of Qdrant can be described as follows:
![Qdrant architecture](/img/blogs/use-kubeblocks-to-build2.png)
