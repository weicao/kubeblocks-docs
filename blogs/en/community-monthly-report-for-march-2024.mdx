...
In March, KubeBlocks officially released v0.8.2. This update notably included the support for [Redis](/docs/preview/kubeblocks-for-redis) Cluster, camellia-redis-proxy, and compatibility with Pulsar v3.0.2. Furthermore, the development team has been actively working on the upcoming v0.9.0.
...
- Supported high-availability access from an external K8s cluster for [MongoDB](/docs/preview/kubeblocks-for-mongodb) Replicaset addresses.
