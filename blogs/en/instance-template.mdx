...
title: Gaining Granular Pod Control in KubeBlocks with Instance Templates
description: Unlock granular control over your database pods in KubeBlocks. This guide explains how to use instance templates to override default settings for individual pods, including resources, scheduling policies, environment variables, and labels. Perfect for customizing clusters like RisingWave.
date: 2024-12-17
authors:
  name: free6om
  url: https://github.com/free6om
  image_url: https://avatars.githubusercontent.com/u/28781141?v=4
tags: [Engineering, Internals]
Keywords: Instance Template, KubeBlocks, Pod Configuration, Kubernetes, Granular Control, ClusterDefinition, ComponentDefinition, RisingWave, Environment Variables, Scheduling Policy, Resource Management, PodTemplate, Customization, Labels, Annotations
...
- [InstanceSet: A New Approach to Stateful Workload Management in KubeBlocks](/blog/instanceset-introduction)
- [In-Place Updates in KubeBlocks](/blog/in-place-updates)
- [How to Take Specified Instances Offline?](/blog/take-specified-instances-offline)
