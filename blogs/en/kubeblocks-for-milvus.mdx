...
- **Message queue**: Used as Milvus's Write-Ahead Log (WAL). In version 2.5, Milvus supports two types of message queues: [Kafka](/kafka-operator) and Pulsar.
...
- [KubeBlocks for Milvus](/milvus-operator)
- [KubeBlocks for Qdrant](/docs/preview/kubeblocks-for-qdrant)
- [KubeBlocks for Kafka](/kafka-operator)
