...
description: 'Case study: How Sealos used KubeBlocks to manage 6,000+ self-hosted databases across four availability zones — architecture, HA, backup, migration and operational practices.'
date: 2024-12-20
authors:
  name: Jinhu Xie
tags: [Use Case]
...
![KubeBlocks Architecture](/img/blogs/manage-6k-db-instances-1.png)
...
![HA Mechanism 1](/img/blogs/manage-6k-db-instances-2.png)
![HA Mechanism 2](/img/blogs/manage-6k-db-instances-3.png)
