...
description: Learn to build and deploy production-grade AIGC applications on Kubernetes. This guide shows how to combine Dify for rapid LLM app development with KubeBlocks to easily manage the required data infrastructure, including PostgreSQL, Redis, and the Qdrant vector database.
date: 2024-07-19
authors:
  name: iziang
...
tags: [Use Case]
Keywords: Dify, KubeBlocks, Kubernetes, AIGC, LLM, PostgreSQL, Redis, Qdrant, Vector Database, Operator, Deployment, LLMOps, Data Infrastructure, Scalability, Stateful
