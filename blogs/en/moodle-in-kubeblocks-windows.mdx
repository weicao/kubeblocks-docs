...
title: Deploy Moodle on K8s with KubeBlocks MySQL Operator
...
tags: [Use Case]
keywords: KubeBlocks,MySQL Operator,Operatorization,Kubernetes,Moodle,Windows,XAMPP,kbcli,kubectl,DBaaS,Database Operator,MySQL,Percona MySQL Operator,Oracle MySQL Operator,Operator-first
image: /img/blogs/thumbnails/blog-moodle.png
---

# Deploy Moodle on K8s with KubeBlocks [MySQL](/docs/preview/kubeblocks-for-mysql) Operator (Windows)
...
## Prepare the [Redis](/docs/preview/kubeblocks-for-redis) Database
...
- [Deploy WordPress on KubeBlocks](/blog/deploy-wordpress-on-kubeblocks)
- [Deploy Harbor on KubeBlocks](/blog/deploy-harbor-on-kubeblocks)
