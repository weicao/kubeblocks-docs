...
description: A detailed performance benchmark of PostgreSQL (PG) on Kubernetes. This report investigates and solves critical performance issues like TPS drops and CPU fluctuations by tuning WAL settings (wal_init_zero, full_page_write), IO bandwidth, and checkpoints.
date: 2023-09-21
authors:
  name: dullboy
  url: https://github.com/nayutah
  image_url: https://avatars.githubusercontent.com/u/111858489?v=4
tags: [PostgreSQL, Addons, Benchmark, Profiling]
Keywords: PostgreSQL, Kubernetes Operator, KubeBlocks, Performance Tuning, Benchmark, WAL, Checkpoint, IO Contention, TPS, wal_init_zero, full_page_write, Stateful Workloads, pgBouncer, XFS, Database on Kubernetes
...
<img src='/img/blogs/k8s-3.jpeg' alt="CPU busy rate"   />
...
<img src='/img/blogs/k8s-4.jpeg' alt="CPU busy rate"   />
...
<img src='/img/blogs/k8s-7.jpeg' alt="TPS drops and CPU fluctuations"   />
...
ZFS and XFS happen to have this COW feature. For more details, refer to [this answer on Reddit](https://www.reddit.com/r/bcachefs/comments/fhws6h/the_state_of_linux_cow_file_systems_what_to_choose/?rdt=58971).
