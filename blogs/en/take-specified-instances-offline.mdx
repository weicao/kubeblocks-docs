...
tags: [Engineering]
keywords: kubeblocks,instanceset,operator,operatorization,specified-instances-offline,scale-down,statefulset-alternative,horizontal-scaling,offlineInstances,opsrequest,kubernetes,postgresql,redis,multi-cluster
