...
title: Is Kubernetes a Database? A Deep Dive into IaD and Declarative APIs
description: Explore the idea of Kubernetes as a database. This article delves into the core concepts of Infrastructure as Data (IaD) and declarative application management to reframe your understanding of how Kubernetes works.
date: 2024-09-26
authors:
  name: Lei Zhang
  url: https://github.com/resouer
  image_url: https://avatars.githubusercontent.com/u/1701782?v=4
tags: [Engineering, Kubernetes, Internals]
Keywords: Kubernetes, Infrastructure as Data (IaD), Declarative API, Controller Pattern, Database, Operator, YAML, CRD, View Layer, Open Application Model (OAM), Control Systems, Application Management, Reconciliation, Schema
...
The way in which Controllers are driven to reconcile the actual and desired states by using declarative descriptions intuitively demonstrates the declarative application management. This process includes two key aspects:
