...
description: Learn how to easily deploy a high-availability (HA) Harbor image repository on Kubernetes. This guide shows how KubeBlocks simplifies the setup of HA PostgreSQL and Redis, providing a reliable and resilient Harbor cluster in minutes.
date: 2024-07-15
authors:
  name: Keyu Liang
...
tags: [Use Case]
Keywords: Harbor, Kubernetes, KubeBlocks, High Availability, PostgreSQL, Redis, Operator, Image Repository, Docker, Deployment, Failover, Cluster, kbcli, Helm, Horizontal Scaling
...
KubeBlocks is an open-source control plane software that runs and manages databases, message queues and other data infrastructure on K8s, and it could manage various types of engines, including RDBMSs (MySQL, [PostgreSQL](/docs/preview/kubeblocks-for-postgresql)), Caches ([Redis](/docs/preview/kubeblocks-for-redis)), NoSQLs (MongoDB), MQs (Kafka, Pulsar), etc.
