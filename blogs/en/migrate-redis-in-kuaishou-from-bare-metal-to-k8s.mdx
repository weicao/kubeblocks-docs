...
description: This is a joint talk delivered by ApeCloud and Kuaishou on KubeCon China 2024. This talk is about migrating large-scale Redis instances at Kuaishou from bare metal to Kubernetes to improve resource utilization.
date: 2024-09-03
authors:
  name: Xueqiang Wu & Yuxing Liu
tags: [Use Case, Redis]
keywords: KubeBlocks,Redis,Kubernetes,Operator,Operatorization,InstanceSet,Sealos,High Availability,In-place Update,Scaling,StatefulSet,Operator P10K,Multi-cluster,Role-based management
...
I’m Xueqiang Wu, and I’m thrilled to be here at KubeCon to share some insights with you. Today, I’ll be co-presenting with Yuxing Liu from Kuaishou, and we’ll discuss the migration of large-scale [Redis](/docs/preview/kubeblocks-for-redis) instances from bare metal to Kubernetes, focusing on how this move can significantly improve resource utilization.
...
![Role](/img/blogs/redis-kuaishou-3.png)
...
![Instance rebuilding](/img/blogs/redis-kuaishou-5.png)
...
To address this, we made some parameter tuning and design changes to the InstanceSet Controller.
...
![Cluster Orchestration](/img/blogs/redis-kuaishou-10.png)
...
![Role management](/img/blogs/redis-kuaishou-11.png)
...
![Overall architecture](/img/blogs/redis-kuaishou-12.png)
...
![Multi cluster distribution](/img/blogs/redis-kuaishou-13.png)
...
![Stability guarantee](/img/blogs/redis-kuaishou-14.png)
