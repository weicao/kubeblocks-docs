...
- Supported creating and deleting official [Redis](/docs/preview/kubeblocks-for-redis) Clusters based on KubeBlocks Sharding API (to be released in v0.8.2).
...
- [MongoDB](/docs/preview/kubeblocks-for-mongodb) supported connections from outside of K8s using host network (#6689).
...
- Fixed the issue of inoperative dynamic parameters. In Patroni [PostgreSQL](/docs/preview/kubeblocks-for-postgresql), if dynamic parameters and static parameters were modified simultaneously, the dynamic parameters did not take effect (#6648).
